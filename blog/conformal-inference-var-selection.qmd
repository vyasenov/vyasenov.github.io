...
date: "2023-12-20"
categories: [machine learning, statistical inference, variable selection]
---
...
Another, more global, approach to using conformal inference for variable importance focuses on the distribution of $\Delta_j(X_{n+1}, Y_{n+1})$ and conducts hypothesis testing on its median or mean. Intuitively, failing to reject the hypothesis that these statistics are zero is evidence that variable $j$ does not play a significant role in predicting $Y$.
