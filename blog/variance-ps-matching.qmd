...
Statistical methods based on the propensity score function come in [different flavors](https://vyasenov.github.io/blog/flavors-prop-score-methods.html) (e.g., [weighting](https://vyasenov.github.io/blog/two-types-weights-causality.html), [matching](https://vyasenov.github.io/blog/flavors-matching-methods.html), subclassification, etc.), but today I will focus on $1:1$ or $1:N$ matching. There are also several potential estimands of interest, such as ATE (average treatment effect) and ATT (ATE for the treatment group), but I will talk specifically about the latter.  
...
We can classify the methods for estimating the PSM variance into three distinct buckets.
...
In follow-up work, [Abadie and Imbens (2016)](https://onlinelibrary.wiley.com/doi/abs/10.3982/ECTA11293) propose a correction which accounts for this uncertainty. Interestingly, in a work that I will discuss below, [Bodory et al. (2020)](https://www.tandfonline.com/doi/abs/10.1080/07350015.2018.1476247) report that in practice this correction might increase or decrease the ATT variance.
