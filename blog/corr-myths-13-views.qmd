...
Overall, what becomes clear is that no correlation coefficient offers a complete or universally superior summary of association. Each captures different aspects of dependence. They are tools, not truths—and should be interpreted in context. Visualizations and complementary diagnostic tests remain indispensable. When the relationship is genuinely nonlinear, I tend to reach for other measures, such as [Chatterjee's coefficient](https://vyasenov.github.io/blog/flavors-correlation-coef.html) or [mutual information](https://vyasenov.github.io/blog/mutual-information.html).
...
4. **As the [cosine of the angle between two vectors](https://vyasenov.github.io/blog/correlation-is-cosine.html)**, showing their geometric alignment.
