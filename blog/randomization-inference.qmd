...
However, it becomes less effective when [covariates](https://vyasenov.github.io/blog/roles-covariates-rtc.html) are correlated with treatment assignment but not properly accounted for, or when the sample size is too small to approximate the randomization distribution reliably through subsampling.
