...
A more trivial scenario leading to the lack of correlation in causal relationships is non-linearity. I do not find this scenario too insightful simply because it can be avoided by using [more sophisticated measures of correlation](https://vyasenov.github.io/blog/corr-myths-13-views.html). See my earlier post on the Chatterjee correlation coefficient.
...
- With the right tools and frameworks, including [methods that recover causal effects without experiments or instruments](https://vyasenov.github.io/blog/causality-wo-experiments.html), we can disentangle the true causal effects, even when correlation gives us a wrong answer.
