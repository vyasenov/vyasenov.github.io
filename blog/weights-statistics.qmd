...
Google is a great starting place. [Lumley’s blog post](http://notstatschat.rbind.io/2020/08/04/weights-in-statistics/) titled Weights in Statistics was incredibly helpful in preparing this article. Stata’s manuals which are publically available contain more detailed information on various types of weighting schemes. See also Solon et al. (2015) for using weights in causal inference.
