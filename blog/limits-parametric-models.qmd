...
Mathematically, the Fisher information $I(\theta)$ is the variance of the partial derivative
...
$$I(\mu)= \mathbb{E}\left[ \left( \frac{\partial}{\partial \mu} \log f(x; \mu) \right)^2 \right] = \frac{1}{\sigma^2}.$$
