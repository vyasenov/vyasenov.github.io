...
where $S_j$ encodes the roughness penalty and $\lambda_j$ is the smoothing parameter.
...
With $\lambda$, $k$, and $f_j$ selected, we can fit the GAM and make predictions. Let's shift the focus on a few more nuianced, but important, topics.
