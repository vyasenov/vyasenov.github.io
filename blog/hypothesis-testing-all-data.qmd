...
This interval clearly contains $0$, so we cannot conclude that there was a real drop in the crime rate between 2018 and 2019. (Here we are testing a single hypothesis; when testing many at once, I have written about the necessary [multiple testing adjustments](https://vyasenov.github.io/blog/flavors-multiple-testing.html).) In other words, the $1.4\%$ drop in homicides between 2018 and 2019 was within the range consistent with the noise in our world. It should not be confused with increased underlying safety in the US.
...
Imagine someone asked us to calculate the probability that there would be fewer than $25$ cases on a given day, but no such day took place in 2018. It would still be naïve to conclude that the probability of this event was zero.
