...
date: "2023-06-30"
categories: [heterogeneous treatment effects, causal inference, variable selection]
---
...
- While Lasso is among the simplest and most popular machine learning algorithms, more suitable methods may exist for estimating HTEs — I survey several of them in my post on the [$S$-, $T$-, $X$-, and $R$-learners](https://vyasenov.github.io/blog/flavors-het-treatment-effects.html).
