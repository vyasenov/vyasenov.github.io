...
The bootstrap became feasible thanks to improvements in computing. It provided a practical, general-purpose way to get confidence intervals and bias corrections for almost any estimator—not just the well-behaved ones. This flexibility is also why the bootstrap has since branched into [many different flavors](https://vyasenov.github.io/blog/flavors-bootstrap.html), including some unconventional ones like the [column-sampling bootstrap](https://vyasenov.github.io/blog/column-sampling-bootstrap.html).
