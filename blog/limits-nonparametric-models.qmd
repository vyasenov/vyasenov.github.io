...
![](../files/nonparametric.png)

The green line corresponds to the Nadaraya-Watson regression with an optimal bandwidth and features some degree of curvature. The red line has a smaller bandwidth (higher variance, lower bias), and the blue line is over-smoothed (higher bandwidth).
